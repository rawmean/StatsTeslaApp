...
const zoomableImages = document.querySelectorAll(
  ".feature-card img:not(.siri-command-icon), .insight-card img, .reviews-hero img, .review-tile img, .release-card img, .timeline-card img, .foundation-card img, .mosaic-panel img, .release-entry img:not(.siri-command-icon), .release-entry-media img:not(.siri-command-icon), .release-entry-media-duo img, .release-entry-media-triple img, .watch-collage img, .feature-media-stack img, .faq-media img"
);
